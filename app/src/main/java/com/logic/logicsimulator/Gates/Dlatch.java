...
public class Dlatch extends BasicGateView {

    public static final String GATE_TYPE="Dlatch";
    public Dlatch(Context context, EditorLayout editorLayout){
        super(context,editorLayout,2,2,0,0);
        super.gateName="Dlatch";
        super.gateType=GATE_TYPE;

        pins[0].setPinName("D");  pins[1].setPinName("E");
