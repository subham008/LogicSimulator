...
public class LowConstantView extends BasicGateView {

	public static final String GATE_TYPE="LowConstant";
	public LowConstantView(Context context , EditorLayout editor){
