...
public class NandGateView extends BasicGateView  {
	public static final String GATE_TYPE="NandGate";
	public NandGateView(Context context,EditorLayout editor,  int inputCount){
	...
	public void drawicon(  RectF r , Canvas canvas,Paint p ){
	   ...
	   p.setStrokeWidth(6);
	     ...
	     canvas.drawArc(ax,ay,ax+width,ay+height,90,-180,false,p);
			 ...
			 canvas.drawCircle(ax+width+6,ay+((height-10)/2), 10, p);
